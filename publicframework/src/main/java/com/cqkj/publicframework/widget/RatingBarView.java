...
import com.cqkj.publicframework.tool.DisplayUtil;
...
public class RatingBarView extends LinearLayout {
    ...
    private ImageView getStarImageView(Context context, AttributeSet attrs) {
        ...
        para.setMargins(DisplayUtil.dp2px(context, 10), 0, 0, 0);
    ...
    public void setStarCount(int startCount,int starImageSize) {
        this.starCount = startCount;
        this.starImageSize = (starImageSize-DisplayUtil.dp2px(context,180)-startCount*30)/startCount;
        initStar();
    }
