package com.cqkj.publicframework.widget.pull;
...
//	private RotateAnimation refreshingAnimation;
    ...
    private boolean his_canPullDown = true;
    private boolean canPullUp = true;
    private boolean his_canPullUp = true;

    private Context mContext;

    public void setCanPullUp(boolean canPullUp) {
        this.canPullUp = canPullUp;
        this.his_canPullUp = canPullUp;
    }

    public void setCanPullDown(boolean canPullDown) {
        this.canPullDown = canPullDown;
        this.his_canPullDown = canPullDown;
    }
...
//			loadingView.startAnimation(refreshingAnimation);
    ...
    private void releasePull() {
        canPullDown = his_canPullDown;
        canPullUp = his_canPullUp;
    }
